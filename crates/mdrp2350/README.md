...
[![Crates.io](https://img.shields.io/crates/v/mdrp2350.svg)](https://crates.io/crates/mdrp2350)
[![Docs.rs](https://docs.rs/mdrp2350/badge.svg)](https://docs.rs/mdrp2350)
...
`mdrp2350` is the RP2350-side of the [mdpicoem](https://github.com/0x4D44/mdpicoem)
...
```rust,no_run
use mdrp2350::{EmulatorBuilder, ExecutionModel};
...
`mdrp2350` ships two interchangeable execution backends, selectable per
emulator instance:
...
- [`mdrp2040`](https://crates.io/crates/mdrp2040) — RP2040 (Cortex-M0+) emulator.
- [`mdpicoem-common`](https://crates.io/crates/mdpicoem-common) — shared primitives.
- [`mdpicoem-devices`](https://crates.io/crates/mdpicoem-devices) — off-chip device models.
