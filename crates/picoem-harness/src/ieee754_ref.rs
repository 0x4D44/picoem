...
/// `F32_MIN_NORMAL_F64` constant in `crates/rp2350_emu/src/core/execute_fpu.rs`;
...
/// but this is a known rp2350_emu simplification).
...
/// cumulative-exception delta. The rp2350_emu implementation does NOT
