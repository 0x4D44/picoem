// silicon_periph_diff_rp2040 — peripheral-state oracle for rp2040_emu vs
...
// in `crates/picoem-harness/src/silicon_periph_rp2040.rs`.
//
...
use picoem_harness::silicon_oracle::Verdict;
use picoem_harness::silicon_periph_rp2040::{self, PeriphArgs, SCENARIOS, TIMER_BASE, XOSC_BASE};
