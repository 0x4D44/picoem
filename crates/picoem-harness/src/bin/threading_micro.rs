...
//! `rp2350_emu::threaded::barrier` — not the local spin-only shim used by
...
use rp2350_emu::threaded::SpinBarrier as ProdSpinBarrier;
...
//
// The production `SpinBarrier` in `rp2350_emu::threaded::barrier` has a
