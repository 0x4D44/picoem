...
// Usage:
//   cargo run -p picoem-harness --release --bin picogus_probe_pc -- \
//       --flash third_party/picogus/picogus-v4.0.0.bin \
//       --bootrom roms/rp2040/bootrom-rp2040-b2.bin \
//       --steps 20000000 --sample-every 500000

use picoem_harness::picogus_pins::{ISA_EXTERNAL_PIN_MASK, ISA_IOR, ISA_IOW};
use rp2040_emu::bus::{CLOCKS_BASE, PIO0_BASE, PIO1_BASE, PLL_SYS_BASE, PLL_USB_BASE};
