//! Full Test Runner for rp2350_emu (ARM Cortex-M33 emulator)
//!
...
//!
//! Usage:
//!   cargo run --release -p picoem-harness --bin full_test_rp2350
//!
//! Options:
...
fn print_help() {
    ...
    println!();
    println!("Full test runner for rp2350_emu ARM Cortex-M33 emulator.");
    println!();
    println!("USAGE:");
    println!("    cargo run --release -p picoem-harness --bin full_test_rp2350 [OPTIONS]");
    println!();
    println!("OPTIONS:");
    ...
    println!();
    println!("EXAMPLES:");
    println!("    cargo run --release -p picoem-harness --bin full_test_rp2350");
    println!("        Run full test suite");
    println!();
    println!("    cargo run --release -p picoem-harness --bin full_test_rp2350 -- --quick");
...
fn main() {
    ...
    println!("rp2350_emu full test runner v{VERSION}");
    println!();
