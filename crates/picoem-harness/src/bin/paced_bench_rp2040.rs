//! Paced benchmark: measures whether the rp2040_emu emulator can sustain
...
fn run_once(cfg: &RunConfig) -> f64 {
    ...
    println!(
        "rp2040_emu paced benchmark — target {} MHz, quantum {} cycles, step_quantum {}, {}, workload {}{}, runtime {}",
        clock_mhz,
        quantum,
        step_quantum,
        core_mode,
