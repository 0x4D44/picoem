//! MMIO trace runner — rp2350_emu (Cortex-M33) bus access logger.
//!
...
//! flag idiom; see `crates/rp2350_emu/src/bus/mod.rs::Bus::emit_mmio_trace`
...
/// no explicit `--bootrom` is given. Matches `rp2350_emu_tui` / `paced_bench_rp2350`.
