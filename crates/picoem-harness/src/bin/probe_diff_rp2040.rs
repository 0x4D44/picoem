// Hardware differential test runner — rp2040_emu (Cortex-M0+) vs real RP2040
// silicon via SWD.
//
...
// all live in `crates/picoem-harness/src/probe_diff_rp2040_lib.rs` so
...
use picoem_harness::m0plus::Bus as M0Bus;
use picoem_harness::probe_diff_rp2040_lib::{
    DiffError, is_m0plus_silicon_safe, rc_for, run_one_diff,
};
use picoem_harness::{TestCase, generate_all, generate_fuzz};
