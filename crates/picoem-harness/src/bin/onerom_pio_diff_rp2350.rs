...
//!
//! Reads `crates/picoem-harness/oracles/onerom_2364.trace`, rebuilds
//! the scenario in our PIO (`picoem-common::pio::PioBlock`), replays
...
use picoem_common::pio::PioBlock;
use picoem_harness::onerom_trace::{self, Trace};
...
// Trace file model (parsing lives in `picoem_harness::onerom_trace`).
...
fn main() -> ExitCode {
    ...
    let trace_path = if args.len() == 2 {
        ...
        PathBuf::from("crates/picoem-harness/oracles/onerom_2364.trace")
    };
