...
// RP2350 oracle (`crates/picoem-harness/src/isr_scenarios.rs`) to the
...
/// TIMER_IRQ_0 (IRQ #0). Matches `rp2040_emu::irq::IRQ_TIMER_IRQ_0`.
pub const IRQ_TIMER_IRQ_0: u32 = 0;
/// TIMER_IRQ_1 (IRQ #1). Matches `rp2040_emu::irq::IRQ_TIMER_IRQ_1`. Used
...
fn apply_init_regs_emu(emu: &mut rp2040_emu::Emulator, init_regs: &[(IsrReg, u32)]) {
    for &(reg, val) in init_regs {
        match reg {
...
fn scenario_preamble_emu(emu: &mut rp2040_emu::Emulator, name: &str) {
    if name == "isr_m0_tail_chain_pendsv_systick" {
...
fn read_observable_emu(emu: &mut rp2040_emu::Emulator, obs: IsrObservable) -> u32 {
    match obs {
...
fn reset_scenario_state_emu(emu: &mut rp2040_emu::Emulator) {
...
pub fn setup_emulator_image(emu: &mut rp2040_emu::Emulator, sc: &IsrScenario) {
...
pub fn run_emu_scenario(emu: &mut rp2040_emu::Emulator, sc: &IsrScenario) -> EmuOutcome {
