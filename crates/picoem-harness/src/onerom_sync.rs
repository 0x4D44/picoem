...
fn capture_block(bus: &mut Bus, block: u8) -> PioSnapshot {
    ...
    // reads at `0x048..=0x0C4` (see `picoem_common::pio::PioBlock::read32`).
...
mod tests {
    ...
    ///
    /// RESETS bit layout (see `rp2350_emu/src/bus/peripherals.rs`): bit 15 =
    ...
    fn new_bus() -> rp2350_emu::Emulator {
