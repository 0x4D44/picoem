...
//!   The enclosing `Mutex<Vec<PioCommand>>` mirrors mdrp2350's shape.
...
/// allocated capacity across quanta (matches mdrp2350's pattern).
...
impl ThreadedPio {
    ...
    /// pattern as mdrp2350's `ThreadedPio::drain_commands`.
...
mod tests {
    ...
    /// Capacity preservation smoke test — mirrors mdrp2350's
