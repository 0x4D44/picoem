...
//! in [`picoem_common::clocks`]; this module owns the RP2040 register
...
// master cycle count via `picoem_common::clocks::pll_cs_read_with_lock`
...
/// `picoem_common::clocks::pll_cs_read_with_lock`.
