...
fn armed_push_expect_echo(emu: &mut rp2040_emu::Emulator, word: u32, expect: u32) {
...
fn seed_core0_nop(emu: &mut rp2040_emu::Emulator) {
...
fn plant_entry_self_loop(emu: &mut rp2040_emu::Emulator, entry: u32) {
