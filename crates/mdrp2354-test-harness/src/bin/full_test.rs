//! Full Test Runner for mdrp2354 (ARM Cortex-M33 emulator)
//!
...
//!
//! Usage:
//!   cargo run --release -p mdrp2354-test-harness --bin full_test
//!
//! Options:
...
fn print_help() {
    ...
    println!();
    println!("Full test runner for mdrp2354 ARM Cortex-M33 emulator.");
    println!();
    println!("USAGE:");
    println!("    cargo run --release -p mdrp2354-test-harness --bin full_test [OPTIONS]");
    println!();
    println!("OPTIONS:");
    ...
    println!();
    println!("EXAMPLES:");
    println!("    cargo run --release -p mdrp2354-test-harness --bin full_test");
    println!("        Run full test suite");
    println!();
    println!("    cargo run --release -p mdrp2354-test-harness --bin full_test -- --quick");
...
fn main() {
    ...
    println!("mdrp2354 full test runner v{VERSION}");
    println!();
