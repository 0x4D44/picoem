...
- **`crates/mdpicoem-devices`** — off-chip device emulation shared by harnesses and apps: `psram.rs` (HyperRAM-style external PSRAM, consumed by `mdrp2040` for `test_psram` compat), `lcd.rs`, `i2s_capture.rs`.
