...
- `picoem-common` — shared primitives crate: `Memory`, `ClockTree` math, `Pacer`, PIO primitive types (`PioBlock`/`StateMachine`), divider/FIFO, and `threaded::{SpinBarrier, SpscQueue}` (x86_64 Windows only).
